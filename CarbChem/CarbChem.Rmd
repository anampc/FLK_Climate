...
```{r}
# Get data
CC.data<-read.csv("Data/NCRMP_carbchem_FLK.csv", header = T)
  summary(CC.data)
  str((CC.data))
...
geom_line(aes (Date, Aragonite_Sat_W, fill=SiteID), shape=21)+
...
geom_point(aes (Date, Temperature_C, fill=SiteID), shape=21)+
