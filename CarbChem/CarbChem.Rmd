...
kable(head(TA.Season, format = "html"))
```
...
kable(head(DIC.Season, format = "html"))
```

**Note:** What is limit for the seasons that makes more sense (now jus using months)?. Wet vs dry/ temoerature/light 
