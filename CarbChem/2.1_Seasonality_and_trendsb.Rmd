...
Year_ploth<- ggplot(Month_Stats) +
        MyTheme +  
        theme(axis.title.x = element_blank(), axis.text.x=element_text(angle = 20, vjust = 0.5))+
        Season_fill+
        Season_colour+
...
TA_exp<- Month_Season_plot+
   geom_abline(slope = 0, intercept = mean_Op$OTA, color="grey")+
   scale_y_continuous(limits = c(2100,2550),
                     expand = c(0.0, 0.0),
...
DIC_Y3<- Year_plot_3+
   geom_abline(slope = 0, intercept = mean_Op$ODIC, color="grey")+
   scale_y_continuous(#limits = c(1800,2900),
                     expand = c(0.2, 0.2),
                     breaks = seq(1800, 2800, 100),
                     name=expression(paste("DIC (", mu, "mol ", kg^-1, ")")))+
...
pH_Y3<- Year_plot_3+
   geom_abline(slope = 0, intercept = mean_Op$OpH, color="grey")+
   scale_y_continuous(breaks = seq(7.7, 8.3, 0.05))+
...
#ggsave(file="FLK_results/Figures/Fig_3/Fig_3_Monthly_ICRS.svg", plot=Seasonality_my3, dpi = 300, width=8.5, height=5)

# ggsave(file="FLK_results/Figures/Fig_3/Fig_3_Monthly_ICRS.svg", plot=Seasonality_my2, dpi = 300, width=9, height=5)
...
#ggsave(file="FLK_results/Figures/Fig_5/Fig_5_mean_YEAR_ICRS.svg", plot=Year_deltas, dpi = 300, width=7.5, height=6)
```
...
dAra_ses.emmc2<-emmeans(dOmega_seson, ~Sub_region*Season, by="Zone")
