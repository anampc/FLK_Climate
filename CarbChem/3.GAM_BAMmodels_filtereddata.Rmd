...
```{r, include=FALSE}
# 1. Get data
WS.data<-read.csv("FLK.data_filtered2.csv", header = T)
...
```{r}
  ...
  WS.reef<-subset(WS.data, WS.data$Zone=="Inshore")
...
# 2. Effects
  ...
  vis.gam(m_DIC, n.grid = 50, theta = 35, phi = 32, zlab = "",
        ticktype = "detailed", color = "topo", main = "t2(D, W)")
  vis.gam(m_DIC, main = "t2(W, D)", plot.type = "contour",
        color = "terrain", contour.col = "black", lwd = 2)
...
vis.gam(m_pCO2, n.grid = 50, theta = 35, phi = 32, zlab = "",
        ticktype = "detailed", color = "topo", main = "t2(D, W)")
vis.gam(m_pCO2, main = "pCO2", plot.type = "contour",
        color = "terrain", contour.col = "black", lwd = 2)
...
# 2. Effects
  ...
  vis.gam(m_pH, main = "pH", plot.type = "contour",
        color = "terrain", contour.col = "black", lwd = 2)
