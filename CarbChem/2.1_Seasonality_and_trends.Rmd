...
write.csv(Month_Stats, "FLK_results/TableS1_Month_Stats.csv",
          row.names = F)
```
...
```{r, echo=FALSE, fig.height=8, fig.width=9}
DIC_my2<-ggarrange(DIC_exp, DIC_Y2,
          labels = c("B", ""),
          ncol = 2, nrow = 1, widths = c(4, 1.5))
DIC_my2
```
...
```{r, echo=FALSE, fig.height=8, fig.width=9}
pCO2_Y2b<-ggarrange(pCO2_exp, pCO2_Y2,
          labels = c("A", "B"),
          ncol = 2, nrow = 1, widths = c(4, 1.5))
pCO2_Y2b
```
...
```{r, echo=FALSE, fig.height=8, fig.width=9}
Om_Y2b<-ggarrange(Omega_exp, Om_Y2,
          labels = c("A", "B"),
          ncol = 2, nrow = 1, widths = c(4, 1.5))
Om_Y2b
```

**Figure 3B:** Aragonite saturation state (omega) by the region and shelf position. Left: monthly mean values, Right: Yearly mean values
...
#ggsave(file="FLK_results/Fig_3_Monthly_means.svg", plot=Seasonality_my2, dpi = 300, width=8, height=7)
...
```{r, echo=FALSE, fig.height=8, fig.width=9}
dTA_my2<-ggarrange(DTA_exp, TA_delta_Y2, dTA_Y3,
          labels = c("A", "B", "C"),
...
```{r, echo=FALSE, fig.height=8, fig.width=9}
dDIC_my2<-ggarrange(dDIC_exp, DIC_delta_Y2, dDIC_Y3,
          labels = c("A", "B",  "C"),
          ncol = 3, nrow = 1, widths = c(3, 2, 1))
dDIC_my2
```
...
```{r, echo=FALSE, fig.height=8, fig.width=8}
dOm_my2<-ggarrange(DOmega_exp,
                   om_delta_Y2 + theme(axis.title.y = element_blank()),
                   dOm_Y3,
          labels = c("A", "B", "C"),
...
## Other seasonal plot options 

```{r, echo=FALSE, fig.height=8, fig.width=9}
TA_DIC_my3<-ggarrange(TA_exp, DIC_exp, 
                      TA_delta_Y2, DIC_delta_Y2+
                        theme(legend.position = "none"),
          labels = c("A", "B", "C", "D"),
          ncol = 2, nrow = 2)
TA_DIC_my3
...
#write.csv(dYearly_Stats, "FLK_results/Table1a_delta_year.csv", row.names = F)
...
#ggsave(file="FLK_results/Fig_4_DELTAS_YEAR.svg", plot=Seasonality_deltas, dpi = 300, width=8.5, height=4)
```
