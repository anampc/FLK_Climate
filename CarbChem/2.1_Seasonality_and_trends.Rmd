...
**Figure 3A:** Total Alkalinity (TA) variation by the region and shelf position by (A) month of the year and (B) season. 
...
**Figure 2B:** Dissolved Inorganic Carbon (DIC) by the region and shelf position. Left: monthly mean values, Right: Yearly mean values
...
TA_delta_Y2<- DeltaYear_plot2+
    ...
    # stat_summary(aes (x=Season, y=dTA_mean),
    #             fun.data = "mean_cl_boot", geom = "point", size=3)+
    # stat_summary(aes (x=Season, y=dTA_mean),
    #             fun.data = "mean_cl_boot", geom = "errorbar",  width = 0.2)
...
```{r, echo=FALSE, fig.height=8, fig.width=9}
dTA_my2<-ggarrange(DTA_exp, TA_delta_Y2,
          #labels = c("dTA by month", "dTA by Year"),
          ncol = 2, nrow = 1, widths = c(3,2))
dTA_my2
```

**Figure 4A:** Seasonal delta Total Alkalinity (dTA) variation by the region and shelf position. 
...
DIC_delta_Y2<- DeltaYear_plot2+
    ...
    # stat_summary(aes (x=Season, y=dDIC_mean),
    #             fun.data = "mean_cl_boot", geom = "point", size=3)+
    # stat_summary(aes (x=Season, y=dDIC_mean),
    #             fun.data = "mean_cl_boot", geom = "errorbar",  width = 0.2)
...
```{r, echo=FALSE, fig.height=8, fig.width=9}
dDIC_my2<-ggarrange(dDIC_exp, DIC_delta_Y2,
          #labels = c("dTA by month", "dTA by Year"),
          ncol = 2, nrow = 1, widths = c(3, 2))
dDIC_my2
```

**Figure 4B:** Seasonal delta Dissolved Inorganic Carbon (dDIC) variation by the region and shelf position. 
