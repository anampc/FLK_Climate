...
**Figure 2A:** Total Alkalinity (TA) variation by the region and shelf position by (A) month of the year and (B) season. 
...
```{r, echo=FALSE, fig.height=8, fig.width=8}
TA_DIC_my3<-ggarrange(TA_exp, TA_delta_Y2,
          #labels = c("dTA by month", "dTA by Year"),
          ncol = 2, nrow = 1, widths = c(3.5, 1.5))
TA_DIC_my3
```
...
Seasonality_deltas<-ggarrange(
          TA_delta_Y2, DIC_delta_Y2, TA_DIC_sum,
          ncol = 3, labels = c("A", "B", "C"),
          widths = c(1, 1, 0.9))
Seasonality_deltas
