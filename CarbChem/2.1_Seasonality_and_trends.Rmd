...
### TA - salinity normalized TA vs Salinity
...
### DIC - salinity normalized DIC vs Salinity
...
# 4. Data for endmember comparissions

```{r}
# Endmember comparisons
...
dMonth_Stats<-Seasonal_Stats %>% 
 mutate_if(is.numeric, round, digits=3)
dMonth_Stats
```

## 5.4 Delta season plots 
...
## 5.5 Month in the inshore reef figures 
...
```{r}
  dreef_Stats<- ddply (Inshore.data, .(Month, Sub_region),
                            summarise,
                  dTA_mean = mean (dTA_MY, na.rm = T),
                  dTA_sd = sd (dTA_MY, na.rm = T),
...
## 5.6 Seasons in the inshore reefs figures 
